...
The `Student` class includes methods to retrieve
a dictionary representation of its attributes, with an option to filter
specific attributes, and to update its attributes from a dictionary.
"""
